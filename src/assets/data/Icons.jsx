...
const Icons  = {
  ...
  tailwind: () => (
      ...
      <svg className="fill-current text-blue-400 " viewBox="0 0 32 32" width="37" xmlns="http://www.w3.org/2000/svg" fill="#000000">
  ...
  javascript: () => (
    <div className="relative group w-max">
      <svg className="  w-full" xmlns="http://www.w3.org/2000/svg" width="30" aria-label="JavaScript" role="img" viewBox="0 0 512 512" fill="#000000">
        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
